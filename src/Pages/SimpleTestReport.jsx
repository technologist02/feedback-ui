...
export const SimpleTestReport = () => {
    ...
    return (
        !loading ? (
            answerIsSuccess ? (<Notification returnFunc={returnFunc}/>) : 
        <div className="container-sm" style={{ maxWidth: "500px" }}>
            ...
            <form className="form-horizontal" method="post">
                ...
                <div className="mb-3">
                    <label htmlFor="incoming-inspection-method" className="form-label">
                ...
                <div className="mb-3">
                    <label htmlFor="incoming-inspection-results" className="form-label">
                    ...
                    {questions.parametersChanged === "Yes" && (
                        <div className="mb-3">
                            ...
                            <textarea
                                ...
                                onChange={(e) =>
                                    setInputValue({ changes: e.target.value })
                                }
                            ></textarea>
                        </div>
                    )}
                ...
                <div className="mb-3">
                    <label htmlFor="output-inspection-method" className="form-label">
                ...
                <div className="mb-3">
                    <label htmlFor="output-inspection-results" className="form-label">
